...
htmlhelp_basename = 'tiny-cbordoc'
...
latex_documents = [
    (master_doc, 'tiny-cbor.tex', 'tiny-cbor Documentation',
     'Intel', 'manual'),
]
...
man_pages = [
    (master_doc, 'tiny-cbor', 'tiny-cbor Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tiny-cbor', 'tiny-cbor Documentation',
     author, 'tiny-cbor', 'One line description of project.',
     'Miscellaneous'),
]
